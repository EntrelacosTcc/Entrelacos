...
// ===== Configurações =====
  ...
  function mostrarResultado() {
    ...
    const textos = {
      animal: '<p>Sua causa é animal! Seu amor pelos animais é evidente. Seja protegendo pets abandonados ou lutando contra a exploração animal, você acredita que todos os seres vivos merecem respeito e compaixão. Provavelmente adora compartilhar vídeos fofos de animais.</p><img src="../assets/img/causa-animal.png" alt="Imagem Causa Animal">',

      ambiental: '<p>Sua causa é ambiental! Você se importa profundamente com o planeta e entende que cada pequena ação conta. Reciclar, economizar água, reduzir o uso de plástico ou simplesmente defender a natureza faz parte do seu dia a dia. Você é daquelas pessoas que não conseguem ver uma árvore sendo cortada sem sentir no peito.</p><img src="../assets/img/causa-ambiental.png" alt="Imagem Causa Ambiental">.',

      religiosa: '<p>Sua causa é a liberdade de fé. Você acredita que cada pessoa deve ter o direito de viver sua espiritualidade, ou sua escolha de não tê-la, com respeito e acolhimento. Para você, é essencial criar espaços de diálogo, compreensão e convivência harmoniosa, onde todas as crenças sejam vistas como legítimas expressões do ser.</p><img src="../assets/img/causa-religiosa.png" alt="Imagem Causa Religiosa">',

      GrupoSubRepresentado: '<p>Sua causa é a defesa de grupos sub-representados. Você acredita que pessoas LGBTQIA+, mulheres e PcD merecem respeito, igualdade e visibilidade reais. Para você, não basta empatia: é preciso agir para que ser quem se é, viver com segurança e ter acesso a oportunidades justas deixe de ser privilégio e se torne, de fato, um direito garantido a todos.</p><img src="../assets/img/causa-minorias.png" alt="Imagem Causa Minorias(Mulheres, PcD e LGBTQIAP+" style="margin-top:200px">',

      social: '<p>Sua causa é o cuidado com a sociedade. Você acredita que cada pessoa merece atenção, apoio e oportunidades para viver bem. Para você, o que transforma o mundo é a união, a empatia entre as pessoas e a disposição de ajudar. É sobre estender a mão, valorizar as diferenças e construir, juntos, um caminho mais humano e solidário. </p><img src="../assets/img/causa-social.png" alt="Imagem Causa Saúde">',

      educacional: '<p>Sua causa é a educação. Você acredita que o acesso ao conhecimento transforma realidades e abre caminhos para a igualdade de oportunidades. Para você, não basta ensinar: é preciso garantir qualidade, inclusão e condições que permitam a todos aprender e crescer. A educação, em sua visão, é direito essencial e base para a justiça social.</p><img src="../assets/img/causa-educacional.png" alt="Imagem Casa Educacional">',

      saude: '<p>Sua causa é a saúde. Você acredita que cuidar do corpo e da mente não deve ser luxo, mas direito assegurado. Para você, não basta oferecer tratamento: é preciso garantir acesso digno, prevenção e bem-estar. A saúde, em sua visão, é pilar fundamental para que cada pessoa viva com qualidade e dignidade.</p><img src="../assets/img/causa-saude.png" alt="Imagem Causa Saúde">'
    };
